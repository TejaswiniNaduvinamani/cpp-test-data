DROP TABLE PRICE_ADMIN.PRC_PROF_COST_SCHEDULE_PKG IF EXISTS;    
drop sequence PRC_PROF_COST_SCHEDULE_PKG_SEQ IF EXISTS;

CREATE TABLE PRICE_ADMIN.PRC_PROF_COST_SCHEDULE_PKG
(
    ...
    CONSTRAINT PRC_PROF_COST_SCHEDULE_PKG_PK PRIMARY KEY (PRC_PROF_COST_SCHEDULE_PKG_SEQ)
);

create sequence PRC_PROF_COST_SCHEDULE_PKG_SEQ as integer start with 1000 ;


CREATE SYNONYM PUBLIC.PRC_PROF_COST_SCHEDULE_PKG FOR PRICE_ADMIN.PRC_PROF_COST_SCHEDULE_PKG;